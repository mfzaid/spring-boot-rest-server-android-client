...
import com.example.rest.template.dummy.DummyContent;
...
public class EmployeeListActivity extends AppCompatActivity {
    ...
    public static class SimpleItemRecyclerViewAdapter
        ...
        private final View.OnClickListener mOnClickListener = new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Employee item = (Employee) view.getTag();
                if (mTwoPane) {
                    Bundle arguments = new Bundle();
                    arguments.putString(EmployeeDetailFragment.ARG_ITEM_ID, String.valueOf(item.getId()));
                    ...
                    intent.putExtra(EmployeeDetailFragment.ARG_ITEM_ID, item.getId());
